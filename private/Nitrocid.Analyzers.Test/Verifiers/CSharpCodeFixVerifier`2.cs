...
namespace Nitrocid.Analyzers.Test
{
        ...
        where TCodeFix : CodeFixProvider, new()
    {
        ...
        public static async Task VerifyAnalyzerAsync(string source, params DiagnosticResult[] expected)
        {
            ...
            test.TestState.AdditionalReferences.Add(MetadataReference.CreateFromFile("../../../public/Nitrocid/KSBuild/net10.0/Nitrocid.Base.dll"));
            test.TestState.AdditionalReferences.Add(MetadataReference.CreateFromFile("../../../public/Nitrocid/KSBuild/net10.0/SpecProbe.Software.dll"));
