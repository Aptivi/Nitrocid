...
using VerifyCS = Nitrocid.Analyzers.Test.CSharpCodeFixVerifier<
    Nitrocid.Analyzers.ConsoleBase.ConsoleTitleUsageAnalyzer,
    Nitrocid.Analyzers.ConsoleBase.ConsoleTitleUsageCodeFixProvider>;

namespace Nitrocid.Analyzers.Test.ConsoleBase
{
    [TestClass]
    public class ConsoleTitleUsageAnalyzerUnitTests
    {
        [TestMethod]
