...
using VerifyCS = Nitrocid.Analyzers.Test.CSharpCodeFixVerifier<
    Nitrocid.Analyzers.ConsoleBase.ConsoleResetColorUsageAnalyzer,
    Nitrocid.Analyzers.ConsoleBase.ConsoleResetColorUsageCodeFixProvider>;

namespace Nitrocid.Analyzers.Test.ConsoleBase
{
    [TestClass]
    public class ConsoleResetColorUsageAnalyzerUnitTests
    {
        [TestMethod]
