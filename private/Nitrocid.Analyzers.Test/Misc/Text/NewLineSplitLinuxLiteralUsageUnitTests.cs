...
using VerifyCS = Nitrocid.Analyzers.Test.CSharpCodeFixVerifier<
    Nitrocid.Analyzers.Misc.Text.NewLineSplitLinuxLiteralUsageAnalyzer,
    Nitrocid.Analyzers.Misc.Text.NewLineSplitLinuxLiteralUsageCodeFixProvider>;
using VerifyCSAlt = Nitrocid.Analyzers.Test.CSharpCodeFixVerifier<
    Nitrocid.Analyzers.Misc.Text.NewLineSplitLinuxLiteralUsageAnalyzer,
    Nitrocid.Analyzers.Misc.Text.NewLineSplitLinuxLiteralUsageAltCodeFixProvider>;

namespace Nitrocid.Analyzers.Test.Misc.Text
{
    [TestClass]
    public class NewLineSplitLinuxLiteralUnitTests
    {
        [TestMethod]
