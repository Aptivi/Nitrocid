...
using VerifyCS = Nitrocid.Analyzers.Test.CSharpCodeFixVerifier<
    Nitrocid.Analyzers.Misc.Text.NewLineSplitEnvironmentNewLineUsageAnalyzer,
    Nitrocid.Analyzers.Misc.Text.NewLineSplitEnvironmentNewLineUsageCodeFixProvider>;
using VerifyCSAlt = Nitrocid.Analyzers.Test.CSharpCodeFixVerifier<
    Nitrocid.Analyzers.Misc.Text.NewLineSplitEnvironmentNewLineUsageAnalyzer,
    Nitrocid.Analyzers.Misc.Text.NewLineSplitEnvironmentNewLineUsageAltCodeFixProvider>;

namespace Nitrocid.Analyzers.Test.Misc.Text
{
    [TestClass]
    public class NewLineSplitEnvironmentNewLineUnitTests
    {
        [TestMethod]
