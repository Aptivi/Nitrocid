...
using VerifyCS = Nitrocid.Analyzers.Test.CSharpCodeFixVerifier<
    Nitrocid.Analyzers.Misc.Text.NewLineSplitOldUsageAnalyzer,
    Nitrocid.Analyzers.Misc.Text.NewLineSplitOldUsageCodeFixProvider>;

namespace Nitrocid.Analyzers.Test.Misc.Text
{
    [TestClass]
    public class NewLineSplitOldUnitTests
    {
        [TestMethod]
