...
localize() {
    ...
    "$dotnetpath" restore "$ROOTDIR/Nitrocid.slnx" --packages "$ROOTDIR/nuget"
...
build() {
    ...
    "$dotnetpath" build "$ROOTDIR/Nitrocid.slnx" -p:Configuration=$releaseconf ${@:2}
    checkvendorerror $?
}
