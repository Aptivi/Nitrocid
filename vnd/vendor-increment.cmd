...
set "releaseFiles=%ROOTDIR%\PKGBUILD-REL %ROOTDIR%\.github\workflows\build-ppa-package-with-lintian.yml %ROOTDIR%\.github\workflows\build-ppa-package.yml %ROOTDIR%\.github\workflows\pushamend.yml %ROOTDIR%\.github\workflows\pushppa.yml %ROOTDIR%\public\Nitrocid.Installers\Nitrocid.Installer\Package.wxs %ROOTDIR%\public\Nitrocid.Installers\Nitrocid.InstallerBundle\Package.wxs %ROOTDIR%\public\Nitrocid.Templates\templates\KSMod\KSMod.csproj %ROOTDIR%\public\Nitrocid.Templates\templates\KSModVB\KSModVB.vbproj %ROOTDIR%\Directory.Build.props %ROOTDIR%\CHANGES.TITLE"
