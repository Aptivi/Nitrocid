...
using Encryptor = System.Security.Cryptography.SHA3_384;
...
namespace Nitrocid.Extras.Sha384Enhanced
{
    ...
    /// </summary>
    public class SHA384Enhanced : BaseEncryptionDriver, IEncryptionDriver
    {
        /// <inheritdoc/>
        public override string DriverName => "SHA384Enhanced";
