...
namespace Nitrocid.Extras.GitShell.Git.Presets
{
    ...
    public class PowerLineBG2Preset : PromptPresetBase, IPromptPreset
    {
        ...
        private string PresetPromptBuilder()
        {
            ...
            [
                new PowerLineSegment(new Color(255, 85, 255), new Color(25, 25, 25), GitShellCommon.BranchName, default, TransitionPartChar)
            ];
        ...
        private string PresetPromptBuilderShowcase()
        {
            ...
            List<PowerLineSegment> segments =
            [
                new PowerLineSegment(new Color(255, 85, 255), new Color(25, 25, 25), "main", default, TransitionPartChar)
            ];
