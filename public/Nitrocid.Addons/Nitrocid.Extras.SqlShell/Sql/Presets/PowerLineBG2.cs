...
namespace Nitrocid.Extras.SqlShell.Sql.Presets
{
    ...
    /// </summary>
    public class SqlPowerLineBG2Preset : PromptPresetBase, IPromptPreset
    {
        ...
        private string PresetPromptBuilder()
        {
            ...
            [
                new PowerLineSegment(new Color(255, 85, 255), new Color(25, 25, 25), SqlShellCommon.DatabaseFileName, default, TransitionPartChar)
            ];
        ...
        private string PresetPromptBuilderShowcase()
        {
            ...
            List<PowerLineSegment> segments =
            [
                new PowerLineSegment(new Color(255, 85, 255), new Color(25, 25, 25), "database.sqlite", default, TransitionPartChar)
            ];
