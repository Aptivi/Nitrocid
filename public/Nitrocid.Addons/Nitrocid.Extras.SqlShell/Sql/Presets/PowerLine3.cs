...
namespace Nitrocid.Extras.SqlShell.Sql.Presets
{
    ...
    /// PowerLine 3 preset
    /// </summary>
    public class SqlPowerLine3Preset : PromptPresetBase, IPromptPreset
    {
        ...
        internal override string PresetPromptBuilder()
        {
            ...
            [
                new PowerLineSegment(new Color(255, 255, 85), new Color(127, 127, 43), SqlShellCommon.DatabaseFileName)
            ];
