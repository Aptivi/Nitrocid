...
{
    /// <summary>
    /// Animated screensavers kernel configuration instance
    /// </summary>
    public partial class AnimatedSaversConfig : BaseKernelConfig
    {
        ...
        public override SettingsEntry[] SettingsEntries
        {
            get
            {
                var dataStream = ResourcesManager.GetData("AnimatedSaverSettings.json", ResourcesType.Misc, typeof(AnimatedSaversConfig).Assembly) ??
