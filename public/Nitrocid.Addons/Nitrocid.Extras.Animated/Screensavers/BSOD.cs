...
using Nitrocid.Extras.Animated.Animations.BSOD;
...
namespace Nitrocid.Extras.Animated.Screensavers
{
    ...
    public class BSODDisplay : BaseScreensaver, IScreensaver
    {
        ...
        private BSODSettings? BSODSettingsInstance;
        /// <inheritdoc/>
        ...
        /// <inheritdoc/>
        public override void ScreensaverLogic() => BSOD.Simulate(BSODSettingsInstance);
