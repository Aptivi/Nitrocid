...
namespace Nitrocid.ShellPacks.Shells.Archive.Presets
{
    ...
    public class ArchivePowerLine2Preset : PromptPresetBase, IPromptPreset
    {
        ...
        private string PresetPromptBuilder()
        {
            ...
            [
                new PowerLineSegment(new Color(255, 85, 255), new Color(127, 43, 127), Path.GetFileName(archiveShell.FileStream?.Name) ?? ""),
                new PowerLineSegment(new Color(0, 0, 0), new Color(255, 85, 255), archiveShell.CurrentArchiveDirectory ?? "")
            ];
        ...
        private string PresetPromptBuilderShowcase()
        {
            ...
            List<PowerLineSegment> segments =
            [
                new PowerLineSegment(new Color(255, 85, 255), new Color(127, 43, 127), "archive.zip"),
                new PowerLineSegment(new Color(0, 0, 0), new Color(255, 85, 255), "/dir")
            ];
