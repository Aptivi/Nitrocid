...
namespace Nitrocid.ShellPacks.Shells.Archive.Presets
{
    ...
    public class ArchivePowerLine1Preset : PromptPresetBase, IPromptPreset
    {
        ...
        private string PresetPromptBuilder()
        {
            ...
            [
                new PowerLineSegment(new Color(85, 255, 255), new Color(43, 127, 127), Path.GetFileName(archiveShell.FileStream?.Name) ?? ""),
                new PowerLineSegment(new Color(0, 0, 0), new Color(85, 255, 255), archiveShell.CurrentArchiveDirectory ?? "")
            ];
