...
namespace Nitrocid.ShellPacks.Shells.RSS.Presets
{
    ...
    public class RSSPowerLineBG1Preset : PromptPresetBase, IPromptPreset
    {
        ...
        private string PresetPromptBuilder()
        {
            ...
            [
                new PowerLineSegment(new Color(85, 255, 255), new Color(25, 25, 25), rssShell.RSSFeedInstance is not null ? new Uri(rssShell.RSSFeedInstance.FeedUrl).Host : "???"),
            ];
        ...
        private string PresetPromptBuilderShowcase()
        {
            ...
            List<PowerLineSegment> segments =
            [
                new PowerLineSegment(new Color(85, 255, 255), new Color(25, 25, 25), "rss.fabrikam.com/news/tech.rss"),
            ];
