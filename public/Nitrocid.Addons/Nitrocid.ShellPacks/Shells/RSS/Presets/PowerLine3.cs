...
namespace Nitrocid.ShellPacks.Shells.RSS.Presets
{
    ...
    public class RSSPowerLine3Preset : PromptPresetBase, IPromptPreset
    {
        ...
        private string PresetPromptBuilder()
        {
            ...
            [
                new PowerLineSegment(new Color(255, 255, 85), new Color(127, 127, 43), rssShell.RSSFeedInstance is not null ? new Uri(rssShell.RSSFeedInstance.FeedUrl).Host : "???"),
            ];
        ...
        private string PresetPromptBuilderShowcase()
        {
            ...
            List<PowerLineSegment> segments =
            [
                new PowerLineSegment(new Color(255, 255, 85), new Color(127, 127, 43), "rss.fabrikam.com/news/tech.rss"),
            ];
