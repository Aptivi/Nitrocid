...
namespace Nitrocid.ShellPacks.Shells.HTTP.Presets
{
    ...
    public class HTTPPowerLineBG1Preset : PromptPresetBase, IPromptPreset
    {
        ...
        internal override string PresetPromptBuilder()
        {
            ...
            [
                new PowerLineSegment(new Color(85, 255, 255), new Color(25, 25, 25), HTTPShellCommon.HTTPSite, PadlockChar)
            ];
        ...
        internal override string PresetPromptBuilderShowcase()
        {
            ...
            List<PowerLineSegment> segments =
            [
                new PowerLineSegment(new Color(85, 255, 255), new Color(25, 25, 25), LanguageTools.GetLocalized("NKS_SHELLPACKS_FTP_DEFAULTPRESET_SHOWCASE_SITE", "Nitrocid.ShellPacks"), PadlockChar)
            ];
