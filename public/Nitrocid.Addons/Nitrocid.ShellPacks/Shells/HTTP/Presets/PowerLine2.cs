...
namespace Nitrocid.ShellPacks.Shells.HTTP.Presets
{
    ...
    /// PowerLine 2 preset
    /// </summary>
    public class HTTPPowerLine2Preset : PromptPresetBase, IPromptPreset
    {
        ...
        internal override string PresetPromptBuilder()
        {
            ...
            [
                new PowerLineSegment(new Color(255, 85, 255), new Color(127, 43, 127), HTTPShellCommon.HTTPSite, PadlockChar)
            ];
        ...
        internal override string PresetPromptBuilderShowcase()
        {
            ...
            List<PowerLineSegment> segments =
            [
                new PowerLineSegment(new Color(255, 85, 255), new Color(127, 43, 127), LanguageTools.GetLocalized("NKS_SHELLPACKS_FTP_DEFAULTPRESET_SHOWCASE_SITE", "Nitrocid.ShellPacks"), PadlockChar)
            ];
