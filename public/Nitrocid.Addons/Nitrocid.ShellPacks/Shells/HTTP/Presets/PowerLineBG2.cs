...
namespace Nitrocid.ShellPacks.Shells.HTTP.Presets
{
    ...
    public class HTTPPowerLineBG2Preset : PromptPresetBase, IPromptPreset
    {
        ...
        internal override string PresetPromptBuilderShowcase()
        {
            ...
            List<PowerLineSegment> segments =
            [
                new PowerLineSegment(new Color(255, 85, 255), new Color(25, 25, 25), LanguageTools.GetLocalized("NKS_SHELLPACKS_FTP_DEFAULTPRESET_SHOWCASE_SITE", "Nitrocid.ShellPacks"), PadlockChar)
            ];
