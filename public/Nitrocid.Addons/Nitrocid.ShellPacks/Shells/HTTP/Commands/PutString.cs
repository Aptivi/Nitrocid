...
namespace Nitrocid.ShellPacks.Shells.HTTP.Commands
{
    class PutStringCommand : BaseCommand, ICommand
    {
        ...
        public override string HelpDefinition =>
            LanguageTools.GetLocalized("NKS_SHELLPACKS_HTTP_COMMAND_PUTSTRING_DESC");
        ...
        public override int Execute(IShell? shell, CommandParameters parameters, ref string variableValue)
        {
            ...
            try
            {
                var ResponseTask = httpShell.HttpPutString(parameters.ArgumentsList[0], parameters.ArgumentsList[1]);
                ResponseTask.Wait();
