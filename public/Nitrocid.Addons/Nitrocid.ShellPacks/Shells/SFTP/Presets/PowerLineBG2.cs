...
namespace Nitrocid.ShellPacks.Shells.SFTP.Presets
{
    ...
    public class SftpPowerLineBG2Preset : PromptPresetBase, IPromptPreset
    {
        ...
        private string PresetPromptBuilder()
        {
            ...
            [
                new PowerLineSegment(new Color(255, 85, 255), new Color(25, 25, 25), client.ConnectionInfo.Username, default, TransitionPartChar),
                new PowerLineSegment(new Color(255, 85, 255), new Color(25, 25, 25), client.ConnectionInfo.Host, PadlockChar, TransitionPartChar),
                new PowerLineSegment(new Color(255, 85, 255), new Color(25, 25, 25), sftpShell.SFTPCurrentRemoteDir ?? "", default, TransitionPartChar),
            ];
