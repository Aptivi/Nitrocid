...
namespace Nitrocid.ShellPacks.Shells.SFTP.Presets
{
    ...
    /// PowerLine 2 preset
    /// </summary>
    public class SftpPowerLine2Preset : PromptPresetBase, IPromptPreset
    {
        ...
        private string PresetPromptBuilder()
        {
            ...
            [
                new PowerLineSegment(new Color(255, 85, 255), new Color(127, 43, 127), client.ConnectionInfo.Username),
                new PowerLineSegment(new Color(0, 0, 0), new Color(85, 255, 255), client.ConnectionInfo.Host, PadlockChar),
                new PowerLineSegment(new Color(0, 0, 0), new Color(255, 255, 255), sftpShell.SFTPCurrentRemoteDir ?? ""),
            ];
        ...
        private string PresetPromptBuilderShowcase()
        {
            ...
            List<PowerLineSegment> segments =
            [
                new PowerLineSegment(new Color(255, 85, 255), new Color(127, 43, 127), LanguageTools.GetLocalized("NKS_SHELLPACKS_FTP_DEFAULTPRESET_SHOWCASE_USER")),
                new PowerLineSegment(new Color(0, 0, 0), new Color(85, 255, 255), LanguageTools.GetLocalized("NKS_SHELLPACKS_FTP_DEFAULTPRESET_SHOWCASE_SITE"), PadlockChar),
