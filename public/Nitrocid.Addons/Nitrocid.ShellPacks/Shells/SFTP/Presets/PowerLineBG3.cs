...
namespace Nitrocid.ShellPacks.Shells.SFTP.Presets
{
    ...
    public class SftpPowerLineBG3Preset : PromptPresetBase, IPromptPreset
    {
        ...
        private string PresetPromptBuilder()
        {
            ...
            [
                new PowerLineSegment(new Color(255, 255, 85), new Color(25, 25, 25), client.ConnectionInfo.Username, default, TransitionPartChar),
                new PowerLineSegment(new Color(255, 255, 85), new Color(25, 25, 25), client.ConnectionInfo.Host, PadlockChar, TransitionPartChar),
                new PowerLineSegment(new Color(255, 255, 85), new Color(25, 25, 25), sftpShell.SFTPCurrentRemoteDir ?? "", default, TransitionPartChar),
            ];
