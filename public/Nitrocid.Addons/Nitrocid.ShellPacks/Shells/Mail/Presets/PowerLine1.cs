    ...
    public class MailPowerLine1Preset : PromptPresetBase, IPromptPreset
    {
        ...
        private string PresetPromptBuilder()
        {
            ...
            [
                ...
                new PowerLineSegment(new Color(0, 0, 0), new Color(85, 255, 255), mailShell.ProtocolType == MailProtocolType.POP3 ? mailShell.NetworkCredential?.UserName ?? "???" : mailShell.IMAP_CurrentDirectory),
            ];
        ...
        private string PresetPromptBuilderShowcase()
        {
            ...
            List<PowerLineSegment> segments =
            [
                new PowerLineSegment(new Color(85, 255, 255), new Color(43, 127, 127), "address@fabrikam.com"),
                new PowerLineSegment(new Color(0, 0, 0), new Color(85, 255, 255), "Inbox"),
            ];
