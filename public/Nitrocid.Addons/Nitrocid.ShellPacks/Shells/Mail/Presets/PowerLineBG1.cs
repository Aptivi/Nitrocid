    ...
    public class MailPowerLineBG1Preset : PromptPresetBase, IPromptPreset
    {
        ...
        private string PresetPromptBuilder()
        {
            ...
            [
                ...
                new PowerLineSegment(new Color(85, 255, 255), new Color(25, 25, 25), mailShell.ProtocolType == MailProtocolType.POP3 ? mailShell.NetworkCredential?.UserName ?? "???" : mailShell.IMAP_CurrentDirectory, default, TransitionPartChar),
            ];
