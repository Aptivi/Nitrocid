...
namespace Nitrocid.ShellPacks.Shells.Mail.Presets
{
    ...
    public class MailPowerLineBG3Preset : PromptPresetBase, IPromptPreset
    {
        ...
        private string PresetPromptBuilder()
        {
            ...
            [
                new PowerLineSegment(new Color(255, 255, 85), new Color(25, 25, 25), mailShell.NetworkCredential ?.UserName ?? "", default, TransitionPartChar),
                new PowerLineSegment(new Color(255, 255, 85), new Color(25, 25, 25), mailShell.ProtocolType == MailProtocolType.POP3 ? mailShell.NetworkCredential?.UserName ?? "???" : mailShell.IMAP_CurrentDirectory, default, TransitionPartChar),
            ];
        ...
        private string PresetPromptBuilderShowcase()
        {
            ...
            List<PowerLineSegment> segments =
            [
                new PowerLineSegment(new Color(255, 255, 85), new Color(25, 25, 25), "address@fabrikam.com", default, TransitionPartChar),
                new PowerLineSegment(new Color(255, 255, 85), new Color(25, 25, 25), "Inbox", default, TransitionPartChar),
            ];
