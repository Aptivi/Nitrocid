...
namespace Nitrocid.ShellPacks.Shells.Mail.Presets
{
    ...
    /// PowerLine 2 preset
    /// </summary>
    public class MailPowerLine2Preset : PromptPresetBase, IPromptPreset
    {
        ...
        private string PresetPromptBuilder()
        {
            ...
            [
                new PowerLineSegment(new Color(255, 85, 255), new Color(127, 43, 127), mailShell.NetworkCredential?.UserName ?? ""),
                new PowerLineSegment(new Color(0, 0, 0), new Color(255, 85, 255), mailShell.ProtocolType == MailProtocolType.POP3 ? mailShell.NetworkCredential?.UserName ?? "???" : mailShell.IMAP_CurrentDirectory),
            ];
        ...
        private string PresetPromptBuilderShowcase()
        {
            ...
            List<PowerLineSegment> segments =
            [
                new PowerLineSegment(new Color(255, 85, 255), new Color(127, 43, 127), "address@fabrikam.com"),
                new PowerLineSegment(new Color(0, 0, 0), new Color(255, 85, 255), "Inbox"),
            ];
