...
namespace Nitrocid.ShellPacks.Shells.Git.Presets
{
    ...
    public class PowerLineBG1Preset : PromptPresetBase, IPromptPreset
    {
        ...
        internal override string PresetPromptBuilder()
        {
            ...
            [
                new PowerLineSegment(new Color(85, 255, 255), new Color(25, 25, 25), GitShellCommon.BranchName, default, TransitionPartChar)
            ];
        ...
        internal override string PresetPromptBuilderShowcase()
        {
            ...
            List<PowerLineSegment> segments =
            [
                new PowerLineSegment(new Color(85, 255, 255), new Color(25, 25, 25), "main", default, TransitionPartChar)
            ];
