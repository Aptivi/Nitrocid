...
namespace Nitrocid.ShellPacks.Shells.Sql.Presets
{
    ...
    /// </summary>
    public class SqlPowerLineBG3Preset : PromptPresetBase, IPromptPreset
    {
        ...
        private string PresetPromptBuilder()
        {
            ...
            [
                new PowerLineSegment(new Color(255, 255, 85), new Color(25, 25, 25), sqlShell.DatabaseFileName, default, TransitionPartChar)
            ];
        ...
        private string PresetPromptBuilderShowcase()
        {
            ...
            List<PowerLineSegment> segments =
            [
                new PowerLineSegment(new Color(255, 255, 85), new Color(25, 25, 25), "database.sqlite", default, TransitionPartChar)
            ];
