...
namespace Nitrocid.ShellPacks.Shells.Sql.Presets
{
    ...
    /// PowerLine 1 preset
    /// </summary>
    public class SqlPowerLine1Preset : PromptPresetBase, IPromptPreset
    {
        ...
        private string PresetPromptBuilder()
        {
            ...
            [
                new PowerLineSegment(new Color(85, 255, 255), new Color(43, 127, 127), SqlShellCommon.DatabaseFileName)
            ];
        ...
        private string PresetPromptBuilderShowcase()
        {
            ...
            List<PowerLineSegment> segments =
            [
                new PowerLineSegment(new Color(85, 255, 255), new Color(43, 127, 127), "database.sqlite")
            ];
