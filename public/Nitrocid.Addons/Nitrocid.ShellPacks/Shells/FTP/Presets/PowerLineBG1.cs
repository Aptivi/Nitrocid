...
namespace Nitrocid.ShellPacks.Shells.FTP.Presets
{
    ...
    public class FtpPowerLineBG1Preset : PromptPresetBase, IPromptPreset
    {
        ...
        private string PresetPromptBuilder()
        {
            ...
            FtpClient? clientFTP = (ftpShell.FTPNetwork?.ConnectionInstance) ??
            ...
            [
                new PowerLineSegment(new Color(85, 255, 255), new Color(25, 25, 25), clientFTP.Credentials.UserName, default, TransitionPartChar),
                new PowerLineSegment(new Color(85, 255, 255), new Color(25, 25, 25), clientFTP.Host, PadlockChar, TransitionPartChar),
                new PowerLineSegment(new Color(85, 255, 255), new Color(25, 25, 25), ftpShell.FtpCurrentRemoteDir, default, TransitionPartChar),
            ];
        ...
        private string PresetPromptBuilderShowcase()
        {
            ...
            List<PowerLineSegment> segments =
            [
                new PowerLineSegment(new Color(85, 255, 255), new Color(25, 25, 25), LanguageTools.GetLocalized("NKS_SHELLPACKS_FTP_DEFAULTPRESET_SHOWCASE_USER"), default, TransitionPartChar),
                new PowerLineSegment(new Color(85, 255, 255), new Color(25, 25, 25), LanguageTools.GetLocalized("NKS_SHELLPACKS_FTP_DEFAULTPRESET_SHOWCASE_SITE"), PadlockChar, TransitionPartChar),
