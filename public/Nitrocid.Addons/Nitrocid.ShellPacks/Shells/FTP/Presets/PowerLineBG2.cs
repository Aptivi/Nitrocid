...
namespace Nitrocid.ShellPacks.Shells.FTP.Presets
{
    ...
    public class FtpPowerLineBG2Preset : PromptPresetBase, IPromptPreset
    {
        ...
        private string PresetPromptBuilder()
        {
            ...
            [
                new PowerLineSegment(new Color(255, 85, 255), new Color(25, 25, 25), clientFTP.Credentials.UserName, default, TransitionPartChar),
                new PowerLineSegment(new Color(255, 85, 255), new Color(25, 25, 25), clientFTP.Host, PadlockChar, TransitionPartChar),
                new PowerLineSegment(new Color(255, 85, 255), new Color(25, 25, 25), ftpShell.FtpCurrentRemoteDir, default, TransitionPartChar),
            ];
