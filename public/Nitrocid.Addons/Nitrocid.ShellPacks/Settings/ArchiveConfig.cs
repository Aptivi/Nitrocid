...
{
    /// <summary>
    /// Configuration instance for archive shell
    /// </summary>
    public class ArchiveConfig : BaseKernelConfig, IKernelConfig
    {
        /// <inheritdoc/>
        [JsonIgnore]
        public override SettingsEntry[] SettingsEntries
        {
            get
            {
                var dataStream = ResourcesManager.GetData("ArchiveSettings.json", ResourcesType.Misc, typeof(ArchiveConfig).Assembly) ??
