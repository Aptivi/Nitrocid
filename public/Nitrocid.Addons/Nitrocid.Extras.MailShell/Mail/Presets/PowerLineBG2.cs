...
namespace Nitrocid.Extras.MailShell.Mail.Presets
{
    ...
    /// </summary>
    public class MailPowerLineBG2Preset : PromptPresetBase, IPromptPreset
    {
        ...
        private string PresetPromptBuilder()
        {
            ...
            [
                new PowerLineSegment(new Color(255, 85, 255), new Color(25, 25, 25), MailLogin.Authentication.UserName, default, TransitionPartChar),
                new PowerLineSegment(new Color(255, 85, 255), new Color(25, 25, 25), MailShellCommon.IMAP_CurrentDirectory, default, TransitionPartChar),
            ];
        ...
        private string PresetPromptBuilderShowcase()
        {
            ...
            List<PowerLineSegment> segments =
            [
                new PowerLineSegment(new Color(255, 85, 255), new Color(25, 25, 25), "address@fabrikam.com", default, TransitionPartChar),
                new PowerLineSegment(new Color(255, 85, 255), new Color(25, 25, 25), "Inbox", default, TransitionPartChar),
            ];
