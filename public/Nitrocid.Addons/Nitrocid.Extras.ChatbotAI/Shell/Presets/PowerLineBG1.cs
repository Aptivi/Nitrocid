...
namespace Nitrocid.Extras.ChatbotAI.Shell.Presets
{
    ...
    /// </summary>
    public class ChatbotPowerLineBG1Preset : PromptPresetBase, IPromptPreset
    {
        ...
        private string PresetPromptBuilder()
        {
            ...
            [
                new PowerLineSegment(new Color(85, 255, 255), new Color(25, 25, 25), "Chatbot AI", default, TransitionPartChar)
            ];
