...
namespace Nitrocid.ConsoleBase.Themes
{
    ...
    public static class ThemeTools
    {
        ...
        {
            { "Default", new ThemeInfo(JToken.Parse(ResourcesManager.ConvertToString(ResourcesManager.GetData("Default.json", ResourcesType.Themes)) ?? "[]")) },
            { "Dynamic", new ThemeInfo(JToken.Parse(ResourcesManager.ConvertToString(ResourcesManager.GetData("Dynamic.json", ResourcesType.Themes)) ?? "[]")) },
            { "NitricAcid", new ThemeInfo(JToken.Parse(ResourcesManager.ConvertToString(ResourcesManager.GetData("NitricAcid.json", ResourcesType.Themes)) ?? "[]")) },
        };
        ...
        public static ThemeInfo GetThemeInfo(string theme, bool throwNotFound = false)
        {
            ...
            if (throwNotFound)
                throw new KernelException(KernelExceptionType.NoSuchTheme, LanguageTools.GetLocalized("NKS_CONSOLEBASE_THEMES_EXCEPTION_INVALIDTEMPLATE"), theme);
        ...
        public static void ApplyTheme(ThemeInfo themeInfo, bool dry = false)
        {
            ...
            if (Config.MainConfig.ConsoleSupportsTrueColor && themeInfo.TrueColorRequired || !themeInfo.TrueColorRequired)
            {
                ...
                if (themeInfo.IsExpired)
                {
                    ...
                    throw new KernelException(KernelExceptionType.ThemeManagement, LanguageTools.GetLocalized("NKS_CONSOLEBASE_THEMES_EXCEPTION_THEMEEXPIRED"), themeInfo.Name, themeInfo.StartMonth, themeInfo.StartDay, themeInfo.EndMonth, themeInfo.EndDay);
                }
            ...
            else
            {
                ...
                throw new KernelException(KernelExceptionType.UnsupportedConsole, LanguageTools.GetLocalized("NKS_CONSOLEBASE_THEMES_EXCEPTION_NEEDSTRUECOLOR"), themeInfo.Name);
            }
        ...
        public static void ApplyThemeFromFile(string ThemeFile, bool dry = false)
        {
            ...
            catch (FileNotFoundException)
            {
                ...
                throw new KernelException(KernelExceptionType.NoSuchTheme, LanguageTools.GetLocalized("NKS_CONSOLEBASE_THEMES_EXCEPTION_INVALIDTEMPLATE"), ThemeFile);
            }
        }
        ...
        public static void SetColorsTheme(ThemeInfo ThemeInfo, bool dry = false)
        {
            ...
            if (MinimumTypeRequired(ThemeInfo, ColorType.TrueColor) && !Config.MainConfig.ConsoleSupportsTrueColor)
                throw new KernelException(KernelExceptionType.UnsupportedConsole, LanguageTools.GetLocalized("NKS_CONSOLEBASE_THEMES_EXCEPTION_NEEDSTRUECOLOR2"));
            ...
            catch (Exception ex)
            {
                ...
                throw new KernelException(KernelExceptionType.Color, LanguageTools.GetLocalized("NKS_CONSOLEBASE_THEMES_PREVIEW_EXCEPTION_INVALIDCOLOR") + " {0}", ex, ex.Message);
            }
        }
