...
namespace Nitrocid.Kernel.Starting
{
    internal static class WelcomeMessage
    {
        ...
        internal static void ShowDevelopmentDisclaimer()
        {
            ...
            string devNoticeTitle = LanguageTools.GetLocalized("NKS_KERNEL_STARTING_DEVNOTICE_TITLE");
            string devNoticeMessage = LanguageTools.GetLocalized("NKS_KERNEL_STARTING_DEVNOTICE_TIP_1");
            ...
            string devNoticeClassic = LanguageTools.GetLocalized("NKS_KERNEL_STARTING_DEVNOTICE_TIP_2");
