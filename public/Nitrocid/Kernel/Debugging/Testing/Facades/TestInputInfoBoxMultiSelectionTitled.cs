...
{
    internal class TestInputInfoBoxMultiSelectionTitled : TestFacade
    {
        public override string TestName => Translate.DoTranslation("Tests the input multiple selection style in the informational box (titled)");
        ...
        public override void Run(params string[] args)
        {
            ...
            var selections = InfoBoxSelectionMultipleColor.WriteInfoBoxSelectionMultiple(nameof(TestInputInfoBoxMultiSelectionTitled), choices, "Which Ubuntu version would you like to run?");
