                        ...
                        new PresentationPage(
                            ...
                            [
                                new PresentationInputInfo(
                                    ...
                                    new ComboBoxModule()
                                    {
                                        Name = LanguageTools.GetLocalized("NKS_KERNEL_FIRSTRUN_LANGAUGE_PROMPT"),
                        ...
                        new PresentationPage(
                            ...
                            [
                                new PresentationInputInfo(
                                    ...
                                    new TextBoxModule()
                                    {
                                        Name = LanguageTools.GetLocalized("NKS_KERNEL_FIRSTRUN_PRESENTATION_USERNAMEPROMPT"),
                                ...
                                new PresentationInputInfo(
                                    ...
                                    {
                                        Name = LanguageTools.GetLocalized("NKS_KERNEL_FIRSTRUN_PRESENTATION_PASSWORDPROMPT"),
