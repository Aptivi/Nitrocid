            ...
            try
            {
                ...
                else if (currentFileSystemEntry.Type == FileSystemEntryType.File)
                {
                    ...
                    if (!selectedFiles.Remove(currentFileSystemEntry.FilePath))
                    {
                        ...
                        InfoBoxModalColor.WriteInfoBoxModal(LanguageTools.GetLocalized("NKS_MISC_INTERACTIVES_FMTUI_SELECTSUCCESS_MULTI"), new InfoBoxSettings() { ForegroundColor = Settings.BoxForegroundColor, BackgroundColor = Settings.BoxBackgroundColor }, currentFileSystemEntry.FilePath);
                    }
                    else
                        InfoBoxModalColor.WriteInfoBoxModal(LanguageTools.GetLocalized("NKS_MISC_INTERACTIVES_FMTUI_UNSELECTSUCCESS_MULTI"), new InfoBoxSettings() { ForegroundColor = Settings.BoxForegroundColor, BackgroundColor = Settings.BoxBackgroundColor }, currentFileSystemEntry.FilePath);
                }
            }
            catch (Exception ex)
            {
