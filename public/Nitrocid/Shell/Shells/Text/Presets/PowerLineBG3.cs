...
namespace Nitrocid.Shell.Shells.Text.Presets
{
    ...
    /// </summary>
    public class TextPowerLineBG3Preset : PromptPresetBase, IPromptPreset
    {
        ...
        private string PresetPromptBuilder()
        {
            ...
            [
                new PowerLineSegment(new Color(255, 255, 85), new Color(25, 25, 25), Path.GetFileName(TextEditShellCommon.FileStream?.Name) ?? "???", default, TransitionPartChar)
            ];
        ...
        private string PresetPromptBuilderShowcase()
        {
            ...
            List<PowerLineSegment> segments =
            [
                new PowerLineSegment(new Color(255, 255, 85), new Color(25, 25, 25), "text.txt", default, TransitionPartChar)
            ];
