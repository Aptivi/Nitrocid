...
namespace Nitrocid.Shell.Shells.Text.Presets
{
    ...
    public class TextPowerLineBG1Preset : PromptPresetBase, IPromptPreset
    {
        ...
        internal override string PresetPromptBuilder()
        {
            ...
            [
                new PowerLineSegment(new Color(85, 255, 255), new Color(25, 25, 25), Path.GetFileName(TextEditShellCommon.FileStream?.Name) ?? "???", default, TransitionPartChar)
            ];
        ...
        internal override string PresetPromptBuilderShowcase()
        {
            ...
            List<PowerLineSegment> segments =
            [
                new PowerLineSegment(new Color(85, 255, 255), new Color(25, 25, 25), "text.txt", default, TransitionPartChar)
            ];
