    ...
    class PermCommand : BaseCommand, ICommand
    {
        ...
        public override int Execute(CommandParameters parameters, ref string variableValue)
        {
            ...
            if (!Enum.TryParse(typeof(PermissionTypes), perm, out object? permission))
            {
                ...
                TextWriters.Write(LanguageTools.GetLocalized("NKS_SHELL_SHELLS_UESH_PERM_NOPERM"), true, ThemeColorType.Error);
            ...
            {
                // No mode
                TextWriters.Write(LanguageTools.GetLocalized("NKS_SHELL_SHELLS_UESH_PERM_NOPERMMODE"), true, ThemeColorType.Error);
                return KernelExceptionTools.GetErrorCode(KernelExceptionType.PermissionManagement);
            }
            return 0;
        }
