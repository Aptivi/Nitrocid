...
namespace Nitrocid.Shell.Shells.UESH.Commands
{
    ...
    /// </summary>
    /// <remarks>
    /// This command lets you securely remove a file or a directory from your current working directory.
    /// </remarks>
    class RmSecCommand : BaseCommand, ICommand
    {
        public override string Command => 
            "rmsec";

        public override string HelpDefinition => 
            LanguageTools.GetLocalized("NKS_SHELL_SHELLS_UESH_COMMAND_RMSEC_DESC");
