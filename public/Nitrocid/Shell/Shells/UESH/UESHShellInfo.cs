...
namespace Nitrocid.Shell.Shells.UESH
{
    ...
    internal class UESHShellInfo : BaseShellInfo<UESHShell>, IShellInfo
    {
        ...
        [
            ...
            new CommandInfo("admin", LanguageTools.GetLocalized("NKS_SHELL_SHELLS_UESH_COMMAND_ADMIN_DESC"), new AdminCommand()),
            ...
            new CommandInfo("changes", LanguageTools.GetLocalized("NKS_SHELL_SHELLS_UESH_COMMAND_CHANGES_DESC"), new ChangesCommand(), CommandFlags.Wrappable),
            ...
            new CommandInfo("debugshell", LanguageTools.GetLocalized("NKS_SHELL_SHELLS_UESH_COMMAND_DEBUGSHELL_DESC"), new DebugShellCommand()),
            ...
            new CommandInfo("logout", LanguageTools.GetLocalized("NKS_SHELL_SHELLS_UESH_COMMAND_LOGOUT_DESC"), new LogoutCommand()),
            ...
            new CommandInfo("lsconnections", LanguageTools.GetLocalized("NKS_SHELL_SHELLS_UESH_COMMAND_LSCONNECTIONS_DESC"), new LsConnectionsCommand(), CommandFlags.RedirectionSupported | CommandFlags.Wrappable),

            new CommandInfo("lsdbgdev", LanguageTools.GetLocalized("NKS_SHELL_SHELLS_UESH_LSDBGDEV_DESC"), new LsDbgDevCommand(), CommandFlags.RedirectionSupported | CommandFlags.Wrappable),
            ...
            new CommandInfo("lsnet", LanguageTools.GetLocalized("NKS_SHELL_SHELLS_UESH_COMMAND_LSNET_DESC"), new LsNetCommand()),
            ...
            new CommandInfo("rdebug", LanguageTools.GetLocalized("NKS_SHELL_SHELLS_UESH_COMMAND_RDEBUG_DESC"), new RdebugCommand()),
            ...
            new CommandInfo("reloadconfig", LanguageTools.GetLocalized("NKS_SHELL_SHELLS_UESH_COMMAND_RELOADCONFIG_DESC"), new ReloadConfigCommand()),
            ...
            new CommandInfo("saveconfig", LanguageTools.GetLocalized("NKS_SHELL_SHELLS_UESH_COMMAND_SAVECONFIG_DESC"), new SaveConfigCommand()),
            ...
            #if SPECIFIERREL
            new CommandInfo("update", LanguageTools.GetLocalized("NKS_SHELL_SHELLS_UESH_COMMAND_UPDATE_DESC"), new UpdateCommand()),
            #endif
