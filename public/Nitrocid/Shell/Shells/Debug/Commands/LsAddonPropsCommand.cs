...
namespace Nitrocid.Shell.Shells.Debug.Commands
{
    ...
    class LsAddonPropsCommand : BaseCommand, ICommand
    {
        ...
        {
            SeparatorWriterColor.WriteSeparatorColor(LanguageTools.GetLocalized("NKS_SHELL_SHELLS_DEBUG_LSPROPERTIES_TITLE") + $" {parameters.ArgumentsList[0]}, {parameters.ArgumentsList[1]}", KernelColorTools.GetColor(KernelColorType.ListTitle));
