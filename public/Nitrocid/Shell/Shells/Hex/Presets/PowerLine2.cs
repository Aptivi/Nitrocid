...
namespace Nitrocid.Shell.Shells.Hex.Presets
{
    ...
    public class HexPowerLine2Preset : PromptPresetBase, IPromptPreset
    {
        ...
        private string PresetPromptBuilder()
        {
            ...
            [
                new PowerLineSegment(new Color(255, 85, 255), new Color(127, 43, 127), HexEditShellCommon.FileStream?.Name ?? "???")
            ];
        ...
        private string PresetPromptBuilderShowcase()
        {
            ...
            List<PowerLineSegment> segments =
            [
                new PowerLineSegment(new Color(255, 85, 255), new Color(127, 43, 127), "file.bin")
            ];
