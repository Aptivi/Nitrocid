...
namespace Nitrocid.Shell.Shells.Hex.Presets
{
    ...
    /// </summary>
    public class HexPowerLineBG3Preset : PromptPresetBase, IPromptPreset
    {
        ...
        private string PresetPromptBuilder()
        {
            ...
            [
                new PowerLineSegment(new Color(255, 255, 85), new Color(25, 25, 25), HexEditShellCommon.FileStream?.Name ?? "???")
            ];
        ...
        private string PresetPromptBuilderShowcase()
        {
            ...
            List<PowerLineSegment> segments =
            [
                new PowerLineSegment(new Color(255, 255, 85), new Color(25, 25, 25), "file.bin")
            ];
