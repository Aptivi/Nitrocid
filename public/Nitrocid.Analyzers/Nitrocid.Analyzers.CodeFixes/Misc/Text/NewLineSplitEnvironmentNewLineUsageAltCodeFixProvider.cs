...
{
    [ExportCodeFixProvider(LanguageNames.CSharp, Name = nameof(NewLineSplitEnvironmentNewLineUsageAltCodeFixProvider)), Shared]
    public class NewLineSplitEnvironmentNewLineUsageAltCodeFixProvider : CodeFixProvider
    {
