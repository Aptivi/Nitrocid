...
{
    [ExportCodeFixProvider(LanguageNames.CSharp, Name = nameof(NewLineSplitCharManagerNewLineUsageCodeFixProvider)), Shared]
    public class NewLineSplitCharManagerNewLineUsageCodeFixProvider : CodeFixProvider
    {
