...
{
    [ExportCodeFixProvider(LanguageNames.CSharp, Name = nameof(NewLineSplitMacOS9LiteralUsageAltCodeFixProvider)), Shared]
    public class NewLineSplitMacOS9LiteralUsageAltCodeFixProvider : CodeFixProvider
    {
        public sealed override ImmutableArray<string> FixableDiagnosticIds =>
            ImmutableArray.Create(NewLineSplitMacOS9LiteralUsageAnalyzer.DiagnosticId);
        ...
        public sealed override async Task RegisterCodeFixesAsync(CodeFixContext context)
        {
            ...
            context.RegisterCodeFix(
                CodeAction.Create(
                    title: CodeFixResources.NewLineSplitMacOS9LiteralUsageCodeFixTitle,
                    createChangedSolution: c => UseTextToolsFormatStringAsync(context.Document, declaration, c),
                    equivalenceKey: nameof(CodeFixResources.NewLineSplitMacOS9LiteralUsageCodeFixTitle)),
                diagnostic);
        }
