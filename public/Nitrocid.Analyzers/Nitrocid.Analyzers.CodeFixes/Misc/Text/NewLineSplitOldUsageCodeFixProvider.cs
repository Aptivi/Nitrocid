...
{
    [ExportCodeFixProvider(LanguageNames.CSharp, Name = nameof(NewLineSplitOldUsageCodeFixProvider)), Shared]
    public class NewLineSplitOldUsageCodeFixProvider : CodeFixProvider
    {
        public sealed override ImmutableArray<string> FixableDiagnosticIds =>
            ImmutableArray.Create(NewLineSplitOldUsageAnalyzer.DiagnosticId);
        ...
        public sealed override async Task RegisterCodeFixesAsync(CodeFixContext context)
        {
            ...
            context.RegisterCodeFix(
                CodeAction.Create(
                    title: CodeFixResources.NewLineSplitOldUsageCodeFixTitle,
                    createChangedSolution: c => UseTextToolsFormatStringAsync(context.Document, declaration, c),
                    equivalenceKey: nameof(CodeFixResources.NewLineSplitOldUsageCodeFixTitle)),
                diagnostic);
        }
