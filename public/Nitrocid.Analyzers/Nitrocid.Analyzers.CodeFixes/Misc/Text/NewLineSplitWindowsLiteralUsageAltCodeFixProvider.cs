...
{
    [ExportCodeFixProvider(LanguageNames.CSharp, Name = nameof(NewLineSplitWindowsLiteralUsageAltCodeFixProvider)), Shared]
    public class NewLineSplitWindowsLiteralUsageAltCodeFixProvider : CodeFixProvider
    {
