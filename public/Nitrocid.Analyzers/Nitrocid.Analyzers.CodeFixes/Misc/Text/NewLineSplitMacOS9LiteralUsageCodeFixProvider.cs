...
{
    [ExportCodeFixProvider(LanguageNames.CSharp, Name = nameof(NewLineSplitMacOS9LiteralUsageCodeFixProvider)), Shared]
    public class NewLineSplitMacOS9LiteralUsageCodeFixProvider : CodeFixProvider
    {
