...
{
    [ExportCodeFixProvider(LanguageNames.CSharp, Name = nameof(NewLineSplitLinuxLiteralUsageCodeFixProvider)), Shared]
    public class NewLineSplitLinuxLiteralUsageCodeFixProvider : CodeFixProvider
    {
