...
{
    [ExportCodeFixProvider(LanguageNames.CSharp, Name = nameof(PathGetFullPathUsageCodeFixProvider)), Shared]
    public class PathGetFullPathUsageCodeFixProvider : CodeFixProvider
    {
        public sealed override ImmutableArray<string> FixableDiagnosticIds =>
            ImmutableArray.Create(PathGetFullPathUsageAnalyzer.DiagnosticId);
        ...
        public sealed override async Task RegisterCodeFixesAsync(CodeFixContext context)
        {
            ...
            context.RegisterCodeFix(
                CodeAction.Create(
                    title: CodeFixResources.PathGetFullPathUsageCodeFixTitle,
                    createChangedSolution: c => UseTextToolsFormatStringAsync(context.Document, declaration, c),
                    equivalenceKey: nameof(CodeFixResources.PathGetFullPathUsageCodeFixTitle)),
                diagnostic);
        }
