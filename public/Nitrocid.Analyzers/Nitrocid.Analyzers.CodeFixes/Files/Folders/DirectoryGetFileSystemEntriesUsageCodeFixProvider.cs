...
namespace Nitrocid.Analyzers.Files.Folders
{
    ...
    public class DirectoryGetFileSystemEntriesUsageCodeFixProvider : CodeFixProvider
    {
        public sealed override ImmutableArray<string> FixableDiagnosticIds =>
            ImmutableArray.Create(DirectoryGetFileSystemEntriesUsageAnalyzer.DiagnosticId);
        ...
        public sealed override async Task RegisterCodeFixesAsync(CodeFixContext context)
        {
            ...
            context.RegisterCodeFix(
                CodeAction.Create(
                    title: CodeFixResources.DirectoryGetFileSystemEntriesUsageCodeFixTitle,
                    createChangedSolution: c => UseTextToolsFormatStringAsync(context.Document, declaration, c),
                    equivalenceKey: nameof(CodeFixResources.DirectoryGetFileSystemEntriesUsageCodeFixTitle)),
                diagnostic);
        }
