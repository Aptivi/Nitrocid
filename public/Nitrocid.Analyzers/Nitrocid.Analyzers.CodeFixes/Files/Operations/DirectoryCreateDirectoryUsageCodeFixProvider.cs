...
{
    [ExportCodeFixProvider(LanguageNames.CSharp, Name = nameof(DirectoryCreateDirectoryUsageCodeFixProvider)), Shared]
    public class DirectoryCreateDirectoryUsageCodeFixProvider : CodeFixProvider
    {
        public sealed override ImmutableArray<string> FixableDiagnosticIds =>
            ImmutableArray.Create(DirectoryCreateDirectoryUsageAnalyzer.DiagnosticId);
        ...
        public sealed override async Task RegisterCodeFixesAsync(CodeFixContext context)
        {
            ...
            context.RegisterCodeFix(
                CodeAction.Create(
                    title: CodeFixResources.DirectoryCreateDirectoryUsageCodeFixTitle,
                    createChangedSolution: c => UseTextToolsFormatStringAsync(context.Document, declaration, c),
                    equivalenceKey: nameof(CodeFixResources.DirectoryCreateDirectoryUsageCodeFixTitle)),
                diagnostic);
        }
