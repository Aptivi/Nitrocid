...
{
    [ExportCodeFixProvider(LanguageNames.CSharp, Name = nameof(PathIsPathRootedUsageCodeFixProvider)), Shared]
    public class PathIsPathRootedUsageCodeFixProvider : CodeFixProvider
    {
        public sealed override ImmutableArray<string> FixableDiagnosticIds =>
            ImmutableArray.Create(PathIsPathRootedUsageAnalyzer.DiagnosticId);
        ...
        public sealed override async Task RegisterCodeFixesAsync(CodeFixContext context)
        {
            ...
            context.RegisterCodeFix(
                CodeAction.Create(
                    title: CodeFixResources.PathIsPathRootedUsageCodeFixTitle,
                    createChangedSolution: c => UseTextToolsFormatStringAsync(context.Document, declaration, c),
                    equivalenceKey: nameof(CodeFixResources.PathIsPathRootedUsageCodeFixTitle)),
                diagnostic);
        }
