...
{
    [ExportCodeFixProvider(LanguageNames.CSharp, Name = nameof(PathGetInvalidPathCharsUsageCodeFixProvider)), Shared]
    public class PathGetInvalidPathCharsUsageCodeFixProvider : CodeFixProvider
    {
        public sealed override ImmutableArray<string> FixableDiagnosticIds =>
            ImmutableArray.Create(PathGetInvalidPathCharsUsageAnalyzer.DiagnosticId);
        ...
        public sealed override async Task RegisterCodeFixesAsync(CodeFixContext context)
        {
            ...
            context.RegisterCodeFix(
                CodeAction.Create(
                    title: CodeFixResources.PathGetInvalidPathCharsUsageCodeFixTitle,
                    createChangedSolution: c => UseTextToolsFormatStringAsync(context.Document, declaration, c),
                    equivalenceKey: nameof(CodeFixResources.PathGetInvalidPathCharsUsageCodeFixTitle)),
                diagnostic);
        }
