...
{
    [ExportCodeFixProvider(LanguageNames.CSharp, Name = nameof(DirectoryExistsUsageCodeFixProvider)), Shared]
    public class DirectoryExistsUsageCodeFixProvider : CodeFixProvider
    {
        public sealed override ImmutableArray<string> FixableDiagnosticIds =>
            ImmutableArray.Create(DirectoryExistsUsageAnalyzer.DiagnosticId);
        ...
        public sealed override async Task RegisterCodeFixesAsync(CodeFixContext context)
        {
            ...
            context.RegisterCodeFix(
                CodeAction.Create(
                    title: CodeFixResources.DirectoryExistsUsageCodeFixTitle,
                    createChangedSolution: c => UseTextToolsFormatStringAsync(context.Document, declaration, c),
                    equivalenceKey: nameof(CodeFixResources.DirectoryExistsUsageCodeFixTitle)),
                diagnostic);
        }
