...
{
    [ExportCodeFixProvider(LanguageNames.CSharp, Name = nameof(DirectoryDeleteUsageCodeFixProvider)), Shared]
    public class DirectoryDeleteUsageCodeFixProvider : CodeFixProvider
    {
        public sealed override ImmutableArray<string> FixableDiagnosticIds =>
            ImmutableArray.Create(DirectoryDeleteUsageAnalyzer.DiagnosticId);
        ...
        public sealed override async Task RegisterCodeFixesAsync(CodeFixContext context)
        {
            ...
            context.RegisterCodeFix(
                CodeAction.Create(
                    title: CodeFixResources.DirectoryDeleteUsageCodeFixTitle,
                    createChangedSolution: c => UseTextToolsFormatStringAsync(context.Document, declaration, c),
                    equivalenceKey: nameof(CodeFixResources.DirectoryDeleteUsageCodeFixTitle)),
                diagnostic);
        }
