...
{
    [ExportCodeFixProvider(LanguageNames.CSharp, Name = nameof(FileDeleteUsageCodeFixProvider)), Shared]
    public class FileDeleteUsageCodeFixProvider : CodeFixProvider
    {
        public sealed override ImmutableArray<string> FixableDiagnosticIds =>
            ImmutableArray.Create(FileDeleteUsageAnalyzer.DiagnosticId);
        ...
        public sealed override async Task RegisterCodeFixesAsync(CodeFixContext context)
        {
            ...
            context.RegisterCodeFix(
                CodeAction.Create(
                    title: CodeFixResources.FileDeleteUsageCodeFixTitle,
                    createChangedSolution: c => UseTextToolsFormatStringAsync(context.Document, declaration, c),
                    equivalenceKey: nameof(CodeFixResources.FileDeleteUsageCodeFixTitle)),
                diagnostic);
        }
