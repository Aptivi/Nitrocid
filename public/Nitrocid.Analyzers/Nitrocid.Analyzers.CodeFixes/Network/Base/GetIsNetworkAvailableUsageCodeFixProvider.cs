...
{
    [ExportCodeFixProvider(LanguageNames.CSharp, Name = nameof(GetIsNetworkAvailableUsageCodeFixProvider)), Shared]
    public class GetIsNetworkAvailableUsageCodeFixProvider : CodeFixProvider
    {
        public sealed override ImmutableArray<string> FixableDiagnosticIds =>
            ImmutableArray.Create(GetIsNetworkAvailableUsageAnalyzer.DiagnosticId);
        ...
        public sealed override async Task RegisterCodeFixesAsync(CodeFixContext context)
        {
            ...
            context.RegisterCodeFix(
                CodeAction.Create(
                    title: CodeFixResources.GetIsNetworkAvailableUsageCodeFixTitle,
                    createChangedSolution: c => UseTextToolsFormatStringAsync(context.Document, declaration, c),
                    equivalenceKey: nameof(CodeFixResources.GetIsNetworkAvailableUsageCodeFixTitle)),
                diagnostic);
        }
