...
{
    [ExportCodeFixProvider(LanguageNames.CSharp, Name = nameof(KernelDateTimeToTimeStringUsageCodeFixProvider)), Shared]
    public class KernelDateTimeToTimeStringUsageCodeFixProvider : CodeFixProvider
    {
        public sealed override ImmutableArray<string> FixableDiagnosticIds =>
            ImmutableArray.Create(KernelDateTimeToTimeStringUsageAnalyzer.DiagnosticId);
        ...
        public sealed override async Task RegisterCodeFixesAsync(CodeFixContext context)
        {
            ...
            context.RegisterCodeFix(
                CodeAction.Create(
                    title: CodeFixResources.KernelDateTimeToTimeStringUsageCodeFixTitle,
                    createChangedSolution: c => UseTextToolsFormatStringAsync(context.Document, declaration, c),
                    equivalenceKey: nameof(CodeFixResources.KernelDateTimeToTimeStringUsageCodeFixTitle)),
                diagnostic);
        }
