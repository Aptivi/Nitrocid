...
{
    [ExportCodeFixProvider(LanguageNames.CSharp, Name = nameof(KernelDateTimeToDateStringUsageCodeFixProvider)), Shared]
    public class KernelDateTimeToDateStringUsageCodeFixProvider : CodeFixProvider
    {
        public sealed override ImmutableArray<string> FixableDiagnosticIds =>
            ImmutableArray.Create(KernelDateTimeToDateStringUsageAnalyzer.DiagnosticId);
        ...
        public sealed override async Task RegisterCodeFixesAsync(CodeFixContext context)
        {
            ...
            context.RegisterCodeFix(
                CodeAction.Create(
                    title: CodeFixResources.KernelDateTimeToDateStringUsageCodeFixTitle,
                    createChangedSolution: c => UseTextToolsFormatStringAsync(context.Document, declaration, c),
                    equivalenceKey: nameof(CodeFixResources.KernelDateTimeToDateStringUsageCodeFixTitle)),
                diagnostic);
        }
