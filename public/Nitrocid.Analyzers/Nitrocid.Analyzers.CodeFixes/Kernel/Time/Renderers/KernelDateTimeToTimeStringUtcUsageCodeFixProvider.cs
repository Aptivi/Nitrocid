...
{
    [ExportCodeFixProvider(LanguageNames.CSharp, Name = nameof(KernelDateTimeToTimeStringUtcUsageCodeFixProvider)), Shared]
    public class KernelDateTimeToTimeStringUtcUsageCodeFixProvider : CodeFixProvider
    {
        public sealed override ImmutableArray<string> FixableDiagnosticIds =>
            ImmutableArray.Create(KernelDateTimeToTimeStringUtcUsageAnalyzer.DiagnosticId);
        ...
        public sealed override async Task RegisterCodeFixesAsync(CodeFixContext context)
        {
            ...
            context.RegisterCodeFix(
                CodeAction.Create(
                    title: CodeFixResources.KernelDateTimeToTimeStringUtcUsageCodeFixTitle,
                    createChangedSolution: c => UseTextToolsFormatStringAsync(context.Document, declaration, c),
                    equivalenceKey: nameof(CodeFixResources.KernelDateTimeToTimeStringUtcUsageCodeFixTitle)),
                diagnostic);
        }
