...
{
    [ExportCodeFixProvider(LanguageNames.CSharp, Name = nameof(ConsoleWriteLineUsageCodeFixProvider)), Shared]
    public class ConsoleWriteLineUsageCodeFixProvider : CodeFixProvider
    {
        public sealed override ImmutableArray<string> FixableDiagnosticIds =>
            ImmutableArray.Create(ConsoleWriteLineUsageAnalyzer.DiagnosticId);
        ...
        public sealed override async Task RegisterCodeFixesAsync(CodeFixContext context)
        {
            ...
            context.RegisterCodeFix(
                CodeAction.Create(
                    title: CodeFixResources.ConsoleWriteLineUsageCodeFixTitle,
                    createChangedSolution: c => UseTextToolsFormatStringAsync(context.Document, declaration, c),
                    equivalenceKey: nameof(CodeFixResources.ConsoleWriteLineUsageCodeFixTitle)),
                diagnostic);
        }
