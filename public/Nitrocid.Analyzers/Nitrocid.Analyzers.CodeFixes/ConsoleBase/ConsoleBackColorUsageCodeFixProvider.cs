...
{
    [ExportCodeFixProvider(LanguageNames.CSharp, Name = nameof(ConsoleBackColorUsageCodeFixProvider)), Shared]
    public class ConsoleBackColorUsageCodeFixProvider : CodeFixProvider
    {
        public sealed override ImmutableArray<string> FixableDiagnosticIds =>
            ImmutableArray.Create(ConsoleBackColorUsageAnalyzer.DiagnosticId);
        ...
        public sealed override async Task RegisterCodeFixesAsync(CodeFixContext context)
        {
            ...
            context.RegisterCodeFix(
                CodeAction.Create(
                    title: CodeFixResources.ConsoleBackColorUsageCodeFixTitle,
                    createChangedSolution: c => UseTextToolsFormatStringAsync(context.Document, declaration, c),
                    equivalenceKey: nameof(CodeFixResources.ConsoleBackColorUsageCodeFixTitle)),
                diagnostic);
        }
