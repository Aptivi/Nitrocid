...
{
    [ExportCodeFixProvider(LanguageNames.CSharp, Name = nameof(ConsoleReadLineUsageCodeFixProvider)), Shared]
    public class ConsoleReadLineUsageCodeFixProvider : CodeFixProvider
    {
        public sealed override ImmutableArray<string> FixableDiagnosticIds =>
            ImmutableArray.Create(ConsoleReadLineUsageAnalyzer.DiagnosticId);
        ...
        public sealed override async Task RegisterCodeFixesAsync(CodeFixContext context)
        {
            ...
            context.RegisterCodeFix(
                CodeAction.Create(
                    title: CodeFixResources.ConsoleReadLineUsageCodeFixTitle,
                    createChangedSolution: c => UseTextToolsFormatStringAsync(context.Document, declaration, c),
                    equivalenceKey: nameof(CodeFixResources.ConsoleReadLineUsageCodeFixTitle)),
                diagnostic);
        }
