...
namespace Nitrocid.Analyzers.Kernel
{
    ...
    public class TermProgramUsageAnalyzer : DiagnosticAnalyzer
    {
        // Some constants
        public const string DiagnosticId = "NKS0042";
        private const string Category = "Kernel";

        // Some strings
        private static readonly LocalizableString Title =
            new LocalizableResourceString(nameof(AnalyzerResources.TermProgramUsageAnalyzerTitle), AnalyzerResources.ResourceManager, typeof(AnalyzerResources));
        private static readonly LocalizableString MessageFormat =
            new LocalizableResourceString(nameof(AnalyzerResources.TermProgramUsageAnalyzerMessageFormat), AnalyzerResources.ResourceManager, typeof(AnalyzerResources));
        private static readonly LocalizableString Description =
            new LocalizableResourceString(nameof(AnalyzerResources.TermProgramUsageAnalyzerDescription), AnalyzerResources.ResourceManager, typeof(AnalyzerResources));
        ...
        public override void Initialize(AnalysisContext context)
        {
            ...
            context.RegisterSyntaxNodeAction(AnalyzeTermProgramUsage, SyntaxKind.SimpleMemberAccessExpression);
        }

        private static void AnalyzeTermProgramUsage(SyntaxNodeAnalysisContext context)
        {
            ...
            if (exp.Parent is InvocationExpressionSyntax invocation)
            {
                ...
                if (argsList.Count == 1)
                {
                    ...
                    if (argToken.ValueText == "TERM_PROGRAM")
                    {
