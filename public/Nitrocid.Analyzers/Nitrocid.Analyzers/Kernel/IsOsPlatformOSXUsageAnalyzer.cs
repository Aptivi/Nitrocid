...
namespace Nitrocid.Analyzers.Kernel
{
    ...
    public class IsOsPlatformOSXUsageAnalyzer : DiagnosticAnalyzer
    {
        // Some constants
        public const string DiagnosticId = "NKS0041";
        private const string Category = "Kernel";

        // Some strings
        private static readonly LocalizableString Title =
            new LocalizableResourceString(nameof(AnalyzerResources.IsOsPlatformOSXUsageAnalyzerTitle), AnalyzerResources.ResourceManager, typeof(AnalyzerResources));
        private static readonly LocalizableString MessageFormat =
            new LocalizableResourceString(nameof(AnalyzerResources.IsOsPlatformOSXUsageAnalyzerMessageFormat), AnalyzerResources.ResourceManager, typeof(AnalyzerResources));
        private static readonly LocalizableString Description =
            new LocalizableResourceString(nameof(AnalyzerResources.IsOsPlatformOSXUsageAnalyzerDescription), AnalyzerResources.ResourceManager, typeof(AnalyzerResources));
        ...
        public override void Initialize(AnalysisContext context)
        {
            ...
            context.RegisterSyntaxNodeAction(AnalyzeIsOsPlatformOSXUsage, SyntaxKind.SimpleMemberAccessExpression);
        }

        private static void AnalyzeIsOsPlatformOSXUsage(SyntaxNodeAnalysisContext context)
        {
