...
namespace Nitrocid.Analyzers.Kernel.Time.Renderers
{
    ...
    public class KernelDateTimeToTimeStringUtcUsageAnalyzer : DiagnosticAnalyzer
    {
        // Some constants
        public const string DiagnosticId = "NKS0031";
        private const string Category = "Kernel";

        // Some strings
        private static readonly LocalizableString Title =
            new LocalizableResourceString(nameof(AnalyzerResources.KernelDateTimeToTimeStringUtcUsageAnalyzerTitle), AnalyzerResources.ResourceManager, typeof(AnalyzerResources));
        private static readonly LocalizableString MessageFormat =
            new LocalizableResourceString(nameof(AnalyzerResources.KernelDateTimeToTimeStringUtcUsageAnalyzerMessageFormat), AnalyzerResources.ResourceManager, typeof(AnalyzerResources));
        private static readonly LocalizableString Description =
            new LocalizableResourceString(nameof(AnalyzerResources.KernelDateTimeToTimeStringUtcUsageAnalyzerDescription), AnalyzerResources.ResourceManager, typeof(AnalyzerResources));
        ...
        public override void Initialize(AnalysisContext context)
        {
            ...
            context.RegisterSyntaxNodeAction(AnalyzeKernelDateTimeToTimeStringUtcUsage, SyntaxKind.SimpleMemberAccessExpression);
        }

        private static void AnalyzeKernelDateTimeToTimeStringUtcUsage(SyntaxNodeAnalysisContext context)
        {
