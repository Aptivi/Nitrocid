...
namespace Nitrocid.Analyzers.Kernel.Time.Renderers
{
    ...
    public class KernelDateTimeToDateStringUtcUsageAnalyzer : DiagnosticAnalyzer
    {
        // Some constants
        public const string DiagnosticId = "NKS0032";
        private const string Category = "Kernel";

        // Some strings
        private static readonly LocalizableString Title =
            new LocalizableResourceString(nameof(AnalyzerResources.KernelDateTimeToDateStringUtcUsageAnalyzerTitle), AnalyzerResources.ResourceManager, typeof(AnalyzerResources));
        private static readonly LocalizableString MessageFormat =
            new LocalizableResourceString(nameof(AnalyzerResources.KernelDateTimeToDateStringUtcUsageAnalyzerMessageFormat), AnalyzerResources.ResourceManager, typeof(AnalyzerResources));
        private static readonly LocalizableString Description =
            new LocalizableResourceString(nameof(AnalyzerResources.KernelDateTimeToDateStringUtcUsageAnalyzerDescription), AnalyzerResources.ResourceManager, typeof(AnalyzerResources));
        ...
        public override void Initialize(AnalysisContext context)
        {
            ...
            context.RegisterSyntaxNodeAction(AnalyzeKernelDateTimeToDateStringUtcUsage, SyntaxKind.SimpleMemberAccessExpression);
        }

        private static void AnalyzeKernelDateTimeToDateStringUtcUsage(SyntaxNodeAnalysisContext context)
        {
