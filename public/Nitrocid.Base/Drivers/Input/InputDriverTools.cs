...
namespace Nitrocid.Base.Drivers.Input
{
    /// <summary>
    /// Input driver tools (strongly typed)
    /// </summary>
    public static class InputDriverTools
    {
        /// <summary>
        /// Sets the input driver
        /// </summary>
        /// <param name="name">Name of the available input driver to set to</param>
        /// <exception cref="KernelException"></exception>
        public static void SetInputDriver(string name) =>
            DriverHandler.SetDriverSafe<IInputDriver>(name);
        ...
        /// <summary>
        /// Gets the input driver names
        /// </summary>
        /// <returns>List of driver names</returns>
        public static string[] GetInputDriverNames()
        {
