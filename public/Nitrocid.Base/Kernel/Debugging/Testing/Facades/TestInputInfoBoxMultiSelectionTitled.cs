...
namespace Nitrocid.Base.Kernel.Debugging.Testing.Facades
{
    ...
    {
        public override string TestName => LanguageTools.GetLocalized("NKS_KERNEL_DEBUGGING_TESTFACADES_TESTINPUTINFOBOXMULTISELECTIONTITLED_DESC");
        ...
        public override void Run()
        {
            ...
            {
                Title = nameof(TestInputInfoBoxMultiSelectionTitled)
            });
