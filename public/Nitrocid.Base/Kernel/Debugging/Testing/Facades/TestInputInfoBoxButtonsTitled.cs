...
{
    internal class TestInputInfoBoxButtonsTitled : TestFacade
    {
        public override string TestName => LanguageTools.GetLocalized("NKS_KERNEL_DEBUGGING_TESTFACADES_TESTINPUTINFOBOXBUTTONSTITLED_DESC");
        ...
        public override void Run()
        {
            ...
            {
                Title = nameof(TestInputInfoBoxButtonsTitled)
            });
