...
namespace Nitrocid.Base.Kernel.Debugging.Testing.Facades
{
    ...
    {
        public override string TestName => LanguageTools.GetLocalized("NKS_KERNEL_DEBUGGING_TESTFACADES_TESTSHA512_DESC");
        ...
        public override void Run()
        {
            ...
            spent.Start();
            TextWriterColor.Write(Encryption.GetEncryptedString("Nitrocid", "SHA512"));
