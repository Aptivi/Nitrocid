...
namespace Nitrocid.Base.Shell.Shells.Hex.Presets
{
    ...
    /// PowerLine 1 preset
    /// </summary>
    public class HexPowerLine1Preset : PromptPresetBase, IPromptPreset
    {
        ...
        private string PresetPromptBuilder()
        {
            ...
            [
                new PowerLineSegment(new Color(85, 255, 255), new Color(43, 127, 127), hexShell.FileStream?.Name ?? "???")
            ];
