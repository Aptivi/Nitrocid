...
namespace Nitrocid.Base.Shell.Shells.Hex.Presets
{
    ...
    /// PowerLine 3 preset
    /// </summary>
    public class HexPowerLine3Preset : PromptPresetBase, IPromptPreset
    {
        ...
        private string PresetPromptBuilder()
        {
            ...
            [
                new PowerLineSegment(new Color(255, 255, 85), new Color(127, 127, 43), hexShell.FileStream?.Name ?? "???")
            ];
        ...
        private string PresetPromptBuilderShowcase()
        {
            ...
            List<PowerLineSegment> segments =
            [
                new PowerLineSegment(new Color(255, 255, 85), new Color(127, 127, 43), "file.bin")
            ];
