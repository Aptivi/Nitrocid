...
namespace Nitrocid.Base.Shell.Shells.Text.Presets
{
    ...
    /// PowerLine 3 preset
    /// </summary>
    public class TextPowerLine3Preset : PromptPresetBase, IPromptPreset
    {
        ...
        private string PresetPromptBuilder()
        {
            ...
            [
                new PowerLineSegment(new Color(255, 255, 85), new Color(127, 127, 43), Path.GetFileName(textShell.FileStream?.Name) ?? "???")
            ];
