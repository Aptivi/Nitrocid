...
namespace Nitrocid.Base.Shell.Shells.Text.Presets
{
    ...
    /// PowerLine 2 preset
    /// </summary>
    public class TextPowerLine2Preset : PromptPresetBase, IPromptPreset
    {
        ...
        private string PresetPromptBuilder()
        {
            ...
            [
                new PowerLineSegment(new Color(255, 85, 255), new Color(127, 43, 127), Path.GetFileName(textShell.FileStream?.Name) ?? "???")
            ];
        ...
        private string PresetPromptBuilderShowcase()
        {
            ...
            List<PowerLineSegment> segments =
            [
                new PowerLineSegment(new Color(255, 85, 255), new Color(127, 43, 127), "text.txt")
            ];
