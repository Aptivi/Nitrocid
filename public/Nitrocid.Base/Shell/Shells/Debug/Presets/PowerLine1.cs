...
namespace Nitrocid.Base.Shell.Shells.Debug.Presets
{
    ...
    /// PowerLine 1 preset
    /// </summary>
    public class DebugPowerLine1Preset : PromptPresetBase, IPromptPreset
    {
        ...
        private string PresetPromptBuilder()
        {
            ...
            [
                new PowerLineSegment(new Color(85, 255, 255), new Color(43, 127, 127), LanguageTools.GetLocalized("NKS_SHELL_PROMPTS_PRESETS_DEBUG")),
            ];
