...
namespace Nitrocid.Base.Shell.Shells.Debug.Presets
{
    ...
    /// PowerLine 2 preset
    /// </summary>
    public class DebugPowerLine2Preset : PromptPresetBase, IPromptPreset
    {
        ...
        private string PresetPromptBuilder()
        {
            ...
            [
                new PowerLineSegment(new Color(255, 85, 255), new Color(127, 43, 127), LanguageTools.GetLocalized("NKS_SHELL_PROMPTS_PRESETS_DEBUG")),
            ];
