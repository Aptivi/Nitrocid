...
namespace Nitrocid.Base.Shell.Shells.Debug.Presets
{
    /// <summary>
    /// PowerLine BG 3 preset
    /// </summary>
    public class DebugPowerLineBG3Preset : PromptPresetBase, IPromptPreset
    {
        ...
        private string PresetPromptBuilder()
        {
            ...
            [
                new PowerLineSegment(new Color(255, 255, 85), new Color(25, 25, 25), LanguageTools.GetLocalized("NKS_SHELL_PROMPTS_PRESETS_DEBUG")),
            ];
