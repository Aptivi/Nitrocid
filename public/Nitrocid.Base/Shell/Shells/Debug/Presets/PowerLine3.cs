...
namespace Nitrocid.Base.Shell.Shells.Debug.Presets
{
    ...
    /// PowerLine 3 preset
    /// </summary>
    public class DebugPowerLine3Preset : PromptPresetBase, IPromptPreset
    {
        ...
        private string PresetPromptBuilder()
        {
            ...
            [
                new PowerLineSegment(new Color(255, 255, 85), new Color(127, 127, 43), LanguageTools.GetLocalized("NKS_SHELL_PROMPTS_PRESETS_DEBUG")),
            ];
