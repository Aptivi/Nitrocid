...
namespace Nitrocid.Base.Shell.Shells.Admin.Presets
{
    ...
    /// </summary>
    public class AdminPowerLineBG3Preset : PromptPresetBase, IPromptPreset
    {
        ...
        private string PresetPromptBuilder()
        {
            ...
            [
                new PowerLineSegment(new Color(255, 255, 85), new Color(25, 25, 25), LanguageTools.GetLocalized("NKS_SHELL_PROMPTS_PRESETS_ADMIN")),
            ];
