...
namespace Nitrocid.Base.Shell.Shells.Admin.Presets
{
    ...
    /// </summary>
    public class AdminPowerLineBG2Preset : PromptPresetBase, IPromptPreset
    {
        ...
        private string PresetPromptBuilder()
        {
            ...
            [
                new PowerLineSegment(new Color(255, 85, 255), new Color(25, 25, 25), LanguageTools.GetLocalized("NKS_SHELL_PROMPTS_PRESETS_ADMIN")),
            ];
